...
export default class Calendar extends React.Component {
  ...
  onNext = () => {
    ...
    this.props.setCalendarYear(this.year());
  };
  setYear = (year) => {
    let dateObject = Object.assign({}, this.state.dateObject);
    ...
    tenyear.map((data) =>
      months.push(
        <td
          ...
          onClick={(e) => {
            this.setYear(data);
            this.props.setCalendarYear(data);
          }}
        >
          <span>{data}</span>
        </td>
            ...
            {findEventsOnSelectedDay(d).length > 0 && (
              ...
              >
                {findEventsOnSelectedDay(d).map((e) => (
                  <Fragment key={e._id}>
                    {moment(e.dateS).tz('America/Toronto').format('HH:mm') ===
                      '00:00' &&
                    moment(e.dateE).tz('America/Toronto').format('HH:mm') ===
                      '23:59' ? (
                      <Fragment>
                        <div className='lh-sm'>
                          Start:{' '}
                        ...
                        <div className='lh-sm'>All Day</div>
                      </Fragment>
                    ) : (
                      <Fragment>
                        <div className='lh-sm'>
